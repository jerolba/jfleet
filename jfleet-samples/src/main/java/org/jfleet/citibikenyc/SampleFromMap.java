...
/*
 * This example shows how to use JFleet to persist a collection of Maps. It's more expensive than using and mapping
 * an object, but it's a sample of the flexibility of JFleet mapping
 */
